...
var URI = "mongodb+srv://deb:Batman2003@backendlearning.tydux.mongodb.net/?retryWrites=true&w=majority&appName=BackEndLearning";
if (!URI) {
                ...
                case 0:
                    ...
                    if (!cached.promise) {
                        ...
                        cached.promise = mongoose_1.default
                            ...
                            exports.gridFsBucket = gridFsBucket = new mongodb_1.GridFSBucket(db, { bucketName: "documents" });
